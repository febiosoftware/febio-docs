...
**Type string:** `"orthotropic elastic"`
...
| `E1` | E1 modulus | 0 | $\gt 0$ | P |
| `E2` | E2 modulus | 0 | $\gt 0$ | P |
| `E3` | E3 modulus | 0 | $\gt 0$ | P |
| `G12` | G12 shear modulus | 0 | $\ge 0$ | P |
| `G23` | G23 shear modulus | 0 | $\ge 0$ | P |
| `G31` | G31 shear modulus | 0 | $\ge 0$ | P |
| `v12` | v12 | 0 | $\in \mathbb{R}$ |  |
| `v23` | v23 | 0 | $\in \mathbb{R}$ |  |
| `v31` | v31 | 0 | $\in \mathbb{R}$ |  |
