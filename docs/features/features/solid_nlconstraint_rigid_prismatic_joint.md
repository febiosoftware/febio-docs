...
**Type string:** `"rigid prismatic joint"`
...
| `force_damping` | force_damping | 0 | $\in \mathbb{R}$ |  |
| `moment_damping` | moment_damping | 0 | $\in \mathbb{R}$ |  |
| `joint_origin` | joint_origin | {0.000000,0.000000,0.000000} | $\in \mathbb{R}^3$ |  |
| `translation_axis` | translation_axis | {1.000000,0.000000,0.000000} | $\in \mathbb{R}^3$ |  |
| `transverse_axis` | transverse_axis | {0.000000,1.000000,0.000000} | $\in \mathbb{R}^3$ |  |
