...
**Type string:** `"moving frame"`

## Parameters

| Name | Description | Default | Range | Units |
|------|-------------|---------|-------|-------|
| `wx` | x-angular velocity | 0 | $\in \mathbb{R}$ | r/t |
| `wy` | y-angular velocity | 0 | $\in \mathbb{R}$ | r/t |
| `wz` | z-angular velocity | 0 | $\in \mathbb{R}$ | r/t |
| `ax` | x-linear acceleration | 0 | $\in \mathbb{R}$ | L/t^2 |
| `ay` | y-linear acceleration | 0 | $\in \mathbb{R}$ | L/t^2 |
| `az` | z-linear acceleration | 0 | $\in \mathbb{R}$ | L/t^2 |
| `frame` | frame | 0 | $[0, 1]$ |  |
