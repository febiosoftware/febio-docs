...
|------|-------------|---------|-------|-------|
| `max_retries` | max retries | 5 | $\in \mathbb{Z}$ |  |
| `opt_iter` | optimal iterations | 11 | $\in \mathbb{Z}$ |  |
| `dtmin` | min stepsize | 0 | $\in \mathbb{R}$ |  |
| `dtmax` | max stepsize | 0.1 | $\in \mathbb{R}$ |  |
| `aggressiveness` | aggressiveness | 0 | $\in \mathbb{Z}$ |  |
| `cutback` | cutback | 0.5 | $\in \mathbb{R}$ |  |
| `dtforce` | dtforce | false | $\{0, 1\}$ |  |
