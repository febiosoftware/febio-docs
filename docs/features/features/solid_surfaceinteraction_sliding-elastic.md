...
| `shell_bottom_primary` | shell_bottom_primary | false | $\{0, 1\}$ |  |
| `shell_bottom_secondary` | shell_bottom_secondary | false | $\{0, 1\}$ |  |
| `offset` | offset | 0 | $\in \mathbb{R}$ | L |
