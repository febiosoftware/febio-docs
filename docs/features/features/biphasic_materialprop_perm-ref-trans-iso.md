...
|------|-------------|---------|-------|-------|
| `perm0` | perm0 | 1 | $\ge 0$ | L^4/F.t |
| `perm1T` | perm1T | 0 | $\ge 0$ | L^4/F.t |
| `perm1A` | perm1A | 0 | $\ge 0$ | L^4/F.t |
| `perm2T` | perm2T | 0 | $\ge 0$ | L^4/F.t |
| `perm2A` | perm2A | 0 | $\ge 0$ | L^4/F.t |
| `M0` | M0 | 0 | $\ge 0$ |  |
| `MT` | MT | 0 | $\ge 0$ |  |
| `MA` | MA | 0 | $\ge 0$ |  |
| `alpha0` | alpha0 | 0 | $\ge 0$ |  |
| `alphaT` | alphaT | 0 | $\ge 0$ |  |
| `alphaA` | alphaA | 0 | $\ge 0$ |  |
