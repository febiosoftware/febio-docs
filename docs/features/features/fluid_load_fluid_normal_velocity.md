...
**Type string:** `"fluid normal velocity"`

## Parameters

| Name | Description | Default | Range | Units |
|------|-------------|---------|-------|-------|
| `velocity` | velocity | 0 | $\in \mathbb{R}$ | L/t |
| `prescribe_nodal_velocities` | prescribe_nodal_velocities | true | $\{0, 1\}$ |  |
| `parabolic` | parabolic | false | $\{0, 1\}$ |  |
| `prescribe_rim_pressure` | prescribe_rim_pressure | false | $\{0, 1\}$ |  |
