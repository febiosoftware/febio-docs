...
| `force_direction` | force_direction | {0.000000,0.000000,-1.000000} | $\in \mathbb{R}^3$ |  |
| `relative` | relative | true | $\{0, 1\}$ |  |
| `rigid_cable_point` | rigid_cable_point |  | N/A |  |
