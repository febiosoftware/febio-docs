...
**Type string:** `"CG-solid"`

## Parameters

| Name | Description | Default | Range | Units |
|------|-------------|---------|-------|-------|
| `symmetric_stiffness` | matrix format | 1 | $[0, 3]$ |  |
| `equation_scheme` | equation_scheme | 0 | $[0, 1]$ |  |
| `equation_order` | equation_order | 0 | $[0, 2]$ |  |
| `optimize_bw` | optimize_bw | false | $\{0, 1\}$ |  |
| `dtol` | dtol | 1e-06 | $\in \mathbb{R}$ |  |
| `etol` | etol | 0.01 | $\in \mathbb{R}$ |  |
| `rtol` | rtol | 0 | $\in \mathbb{R}$ |  |
| `min_residual` | min_residual | 1e-20 | $\in \mathbb{R}$ |  |
| `beta` | beta | 0.25 | $\in \mathbb{R}$ |  |
| `gamma` | gamma | 0.5 | $\in \mathbb{R}$ |  |
| `lstol` | lstol | 0.9 | $\in \mathbb{R}$ |  |
| `lsmin` | lsmin | 1e-15 | $\in \mathbb{R}$ |  |
| `lsiter` | lsiter | 10 | $\in \mathbb{Z}$ |  |
| `cgmethod` | cgmethod | 0 | $\in \mathbb{Z}$ |  |
| `preconditioner` | preconditioner | 0 | $\in \mathbb{Z}$ |  |
