...
|------|-------------|---------|-------|-------|
| `pressure` | pressure | 0 | $\in \mathbb{R}$ | P |
| `radius` | Pipette radius | 0 | $\in \mathbb{R}$ | L |
| `center` | Pipette center | {0.000000,0.000000,0.000000} | $\in \mathbb{R}^3$ | L |
| `normal` | Pipette normal | {0.000000,0.000000,1.000000} | $\in \mathbb{R}^3$ |  |
