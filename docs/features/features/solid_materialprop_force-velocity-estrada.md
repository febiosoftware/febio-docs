...
|------|-------------|---------|-------|-------|
| `ascl` | ascl | 0 | $\in \mathbb{R}$ |  |
| `Tmax` | Tmax | 1 | $\in \mathbb{R}$ |  |
| `ca0` | ca0 | 1 | $\in \mathbb{R}$ |  |
| `camax` | camax | 0 | $\in \mathbb{R}$ |  |
| `beta` | beta | 0 | $\in \mathbb{R}$ |  |
| `l0` | l0 | 0 | $\in \mathbb{R}$ |  |
| `refl` | refl | 0 | $\in \mathbb{R}$ |  |
| `alpha1` | alpha1 | 0 | $\in \mathbb{R}$ |  |
| `alpha2` | alpha2 | 0 | $\in \mathbb{R}$ |  |
| `alpha3` | alpha3 | 0 | $\in \mathbb{R}$ |  |
| `A1` | A1 | 0 | $\in \mathbb{R}$ |  |
| `A2` | A2 | 0 | $\in \mathbb{R}$ |  |
| `A3` | A3 | 0 | $\in \mathbb{R}$ |  |
| `a_t` | a_t | 0 | $\in \mathbb{R}$ |  |
| `force_velocity` | force_velocity | true | $\{0, 1\}$ |  |
