...
**Type string:** `"rigid spherical joint"`
...
| `rotation_x` | rotation_x | 0 | $\in \mathbb{R}$ |  |
| `rotation_y` | rotation_y | 0 | $\in \mathbb{R}$ |  |
| `rotation_z` | rotation_z | 0 | $\in \mathbb{R}$ |  |
| `moment_x` | moment_x | 0 | $\in \mathbb{R}$ |  |
| `moment_y` | moment_y | 0 | $\in \mathbb{R}$ |  |
| `moment_z` | moment_z | 0 | $\in \mathbb{R}$ |  |
