...
| `kc` | kc | 0 | $\in \mathbb{R}$ |  |
| `p` | p | 4 | $\in \mathbb{R}$ |  |
| `R_in` | R_in | 1 | $\in \mathbb{R}$ |  |
| `R_out` | R_out | 2 | $\in \mathbb{R}$ |  |
| `R0_min` | R0_min | 0 | $\in \mathbb{R}$ |  |
| `w_tol` | w_tol | 0 | $\in \mathbb{R}$ |  |
| `check_intersections` | check_intersections | false | $\{0, 1\}$ |  |
| `integration_rule` | integration_rule | 0 | $[0, 1]$ |  |
| `exclude_neighbors` | exclude_neighbors | true | $\{0, 1\}$ |  |
