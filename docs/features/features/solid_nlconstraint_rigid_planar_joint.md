...
**Type string:** `"rigid planar joint"`
...
| `rotation_axis` | rotation_axis | {0.000000,0.000000,0.000000} | $\in \mathbb{R}^3$ |  |
| `translation_axis_1` | translation_axis_1 | {0.000000,0.000000,0.000000} | $\in \mathbb{R}^3$ |  |
...
| `prescribed_translation_1` | prescribed_translation_1 | false | $\{0, 1\}$ |  |
| `translation_1` | translation_1 | 0 | $\in \mathbb{R}$ |  |
| `prescribed_translation_2` | prescribed_translation_2 | false | $\{0, 1\}$ |  |
| `translation_2` | translation_2 | 0 | $\in \mathbb{R}$ |  |
