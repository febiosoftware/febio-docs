...
**Type string:** `"Mooney-Rivlin von Mises Fibers"`
...
| `c1` | c1 | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `c2` | c2 | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `c3` | c3 | 0 | $\in \mathbb{R}$ |  |
| `c4` | c4 | 0 | $\in \mathbb{R}$ |  |
| `c5` | c5 | 0 | $\in \mathbb{R}$ |  |
| `lam_max` | lam_max | 1 | $\in \mathbb{R}$ |  |
| `kf` | kf | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `tp` | tp | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `gipt` | gipt | -842150451 | $\in \mathbb{Z}$ |  |
| `vmc` | vmc | -842150451 | $\in \mathbb{Z}$ |  |
| `var_n` | var_n | -6.27744e+66 | $\in \mathbb{R}$ |  |
