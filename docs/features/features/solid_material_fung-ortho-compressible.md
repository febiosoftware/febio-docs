...
**Type string:** `"Fung-ortho-compressible"`
...
| `G12` | G12 | -6.27744e+66 | $\in \mathbb{R}$ | P |
| `G23` | G23 | -6.27744e+66 | $\in \mathbb{R}$ | P |
| `G31` | G31 | -6.27744e+66 | $\in \mathbb{R}$ | P |
| `v12` | v12 | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `v23` | v23 | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `v31` | v31 | -6.27744e+66 | $\in \mathbb{R}$ |  |
| `c` | c | -6.27744e+66 | $\gt 0$ | P |
| `k` | k | -6.27744e+66 | $\gt 0$ | P |
| `mat_axis` | mat_axis |  | N/A |  |


## Description

The material type for unconstrained orthotropic Fung elasticity [^1][^2] is `Fung-ortho-compressible`.
