...
**Type string:** `"normal_traction"`

## Parameters

| Name | Description | Default | Range | Units |
|------|-------------|---------|-------|-------|
| `traction` | mixture normal traction | 1 | $\in \mathbb{R}$ | P |
| `linear` | linear | false | $\{0, 1\}$ |  |
| `shell_bottom` | apply on shell bottom | false | $\{0, 1\}$ |  |
| `effective` | effective | false | $\{0, 1\}$ |  |
