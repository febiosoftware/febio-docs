...
**Type string:** `"relaxation-power-distortion"`
...
The material type for this relaxation function is `relaxation-power-distortion`.
...
The definition of $K_{2}\left(v\right)$ is given in Section [relaxation-exp-dist-user](solid_materialprop_relaxation-exp-dist-user.md).
