...
| `etol` | etol | 0.01 | $\ge 0$ |  |
| `rtol` | rtol | 0 | $\ge 0$ |  |
| `rhoi` | rhoi | -2 | $\in \mathbb{R}$ |  |
| `alpha` | alpha | 1 | $\in \mathbb{R}$ |  |
| `beta` | beta | 0.25 | $\in \mathbb{R}$ |  |
| `gamma` | gamma | 0.5 | $\in \mathbb{R}$ |  |
| `logSolve` | logSolve | false | $\{0, 1\}$ |  |
| `arc_length` | arc_length | 0 | $\in \mathbb{Z}$ |  |
| `arc_length_scale` | arc_length_scale | 0 | $\in \mathbb{R}$ |  |
